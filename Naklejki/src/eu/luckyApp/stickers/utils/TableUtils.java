...
public class TableUtils {
	...
	public static void copySelectionToClipboard(TableView<?> table) {
		...
		for (TablePosition position : positionList) {
	    	...
	    	else if(observableValue instanceof String){
	    		text=((String)observableValue);
	    	}
	    	else if(observableValue instanceof ReadOnlyObjectWrapper){
	    		ReadOnlyObjectWrapper readOnlyObjectWrapper=(ReadOnlyObjectWrapper)observableValue;
	    		//readOnlyObjectWrapper.
	    		text=readOnlyObjectWrapper.asString().getValue();
			}
	    	else {
	    		
	    		System.out.println("Unsupported observable value: " + observableValue+" type:"+observableValue.getClass().getName());
	    	}
		...
		while( rowTokenizer.hasMoreTokens()) {
		    ...
		    while( columnTokenizer.hasMoreTokens()) {
		    	...
		    	if( observableValue instanceof DoubleProperty) { 
		    		...
		    		//ReadOnlyObjectWrapper readOnlyObjectWrapper =(ReadOnlyObjectWrapper)observableValue;
		    		//readOnlyObjectWrapper.setValue(clipboardCellContent);
		    		((ReadOnlyObjectWrapper) observableValue).set(clipboardCellContent);
		    		((ReadOnlyObjectWrapper) observableValue).setValue(clipboardCellContent);
		    		//table.getItems().set(index, element)
		    		//readOnlyObjectWrapper.
		    		System.out.println("clipboardcontent: "+clipboardCellContent);
		    		//readOnlyObjectWrapper.s
		    		
		    	}
		    	else {
		    		
		    		System.out.println("Unsupported observable value: " + observableValue+" "+observableValue.getClass().getName());
